...
for f in $SERVICEDIR/*; do
    _service=${f##*/}
    case "${_service}" in
        agetty-console|agetty-generic|agetty-h*|agetty-serial|agetty-tty[SAU]*|agetty-tty3|agetty-tty4|agetty-tty5|agetty-tty6|alsa|boltd|cups-browsed|dhcpcd-*|dmeventd|elogind|fancontrol|iptables|ip6tables|isc-ntpd|lvmetad|mysqld|mdadm|pulseaudio|polkitd|rtkit|slapd|sshd|sulogin|tcsd|wpa_supplicant) ;; # ignored
