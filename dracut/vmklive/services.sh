...
for f in $SERVICEDIR/*; do
    _service=${f##*/}
    case "${_service}" in
        agetty-console|agetty-generic|agetty-hv*|agetty-serial|agetty-tty[SAU]*|agetty-tty3|agetty-tty4|agetty-tty5|agetty-tty6|alsa|boltd|cups-browsed|dhcpcd-*|dmeventd|elogind|fancontrol|gpsd|iptables|ip6tables|isc-ntpd|lvmetad|mysqld|mdadm|openntpd|pipewire|pipewire-pulse|pulseaudio|polkitd|rsyncd|rtkit|slapd|smartd|sshd|sulogin|svnserve|tcsd|wireplumber|wpa_supplicant) ;; # ignored
