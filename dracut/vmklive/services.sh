...
for f in $SERVICEDIR/*; do
    _service=${f##*/}
    case "${_service}" in
        agetty-console|agetty-generic|agetty-h*|agetty-serial|agetty-tty[SAU]*|agetty-tty3|agetty-tty4|agetty-tty5|agetty-tty6|adb|alsa|boltd|colord|cups-browsed|dhcpcd-*|dmeventd|fancontrol|iptables|ip6tables|isc-ntpd|lvmetad|mysqld|mdadm|pulseaudio|polkitd|rsyncd|rtkit|slapd|smartd|sshd|sulogin|tcsd|wpa_supplicant) ;; # ignored
