...
for f in $SERVICEDIR/*; do
    _service=${f##*/}
    case "${_service}" in
        agetty-console|agetty-generic|agetty-hv*|agetty-serial|agetty-tty[SAU]*|agetty-tty3|agetty-tty4|agetty-tty5|agetty-tty6|adb|alsa|boltd|cups-browsed|dhcpcd-*|dmeventd|elogind|fancontrol|gpsd|iptables|ip6tables|isc-ntpd|lvmetad|mysqld|mdadm|pulseaudio|polkitd|rsyncd|rtkit|slapd|smartd|sshd|sulogin|svnserve|tcsd|wpa_supplicant) ;; # ignored
